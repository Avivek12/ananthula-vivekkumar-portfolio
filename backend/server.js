...
db.serialize(() => {
  ...
  // Insert initial row for likes if not exists
...
// Simple auth with admin password
const ADMIN_PASSWORD = "VivekListOfFeedback123"; // ⚡ move laterto .env 
...
// Fetch all messages (for your dashboard)
